...
using Pantec.E3Wrapper.Core.Application.Extensions;
...
namespace Pantec.E3Wrapper.Core.Application.Entities.Extensions
{
    public static class EntityExtensions
    {
            ...
            where T : IDisposable where TProxy : E3ProxyBase
        {
            ...
            var t = Type.GetType($"Pantec.E3Wrapper.Core.Application.Entities.{typeName}", true);

            return (T) Activator.CreateInstance(t ?? throw new TypeLoadException($"Unable to find 'Pantec.E3Wrapper.Core.Application.Entities.{typeName}'"), entity);
        }
