...
namespace Pantec.E3Wrapper.Core.Application.Entities.Base
{
    ...
    public abstract class ProxyWrapperBase<T> : IProxyWrapper, IProxyProvider<T> where T : E3ProxyBase
    {
        ...
        /// <para>Calling <see cref="M:Pantec.E3Wrapper.Core.Application.Entities.Base.ProxyWrapperBase.Dispose" /> makes object disposed. 
        /// Any subsequent call on any method except <see cref="M:Pantec.E3Wrapper.Core.Application.Base.ProxyWrapperBase.Dispose" /> would throw 
