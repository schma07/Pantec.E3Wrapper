...
namespace Pantec.E3Proxy
{
    ...
    /// </summary> 
    public sealed class E3JobProxy : E3ProxyBase, IAttributed
    {
        ...
        public object CreateAttributeDefinitionObject()
        {
            return ComObject.CreateAttributeDefinitionObject();
        }
        ...
        public object CreateCavityPartObject()
        {
            return ComObject.CreateCavityPartObject();
        }

        public object CreateClipboardObject()
        {
            return ComObject.CreateClipboardObject();
        }
        ...
        {
            return ComObject.CreateEmbeddedObject();
        }
        ...
        {
            return ComObject.CreateInlineConnectorsOnConnectionLine(out newCoreIDs, out newDeviceIDs, flags, ref LineIDs, CompName, CompVersion, ref newSymbolIDs);
        }
        ...
        {
            return ComObject.CreateStateObject();
        }
        ...
        {
            return ComObject.ExportBoardLayout(type, file, flags, map, exclusions);
        }

        public int ExportCGM(string file, ref object shtids, int options)
        {
            return ComObject.ExportCGM(file, shtids, options);
        }
        ...
        {
            return ComObject.ExportDrawing(name, shtids, options);
        }
        ...
        {
            return ComObject.ExportImageItems(format, version, file, items, percentage, width, height, clrdepth, gray, dpiX, dpiY, compressionmode);
        }
        public int ExportJT(string file, ref object ids, int flags = 1)
        {
            return ComObject.ExportJT(file, ref ids, flags);
        }
        ...
        public int ExportPDF(string file, ref object shtids, int options, string password = default(string))
        {
            return ComObject.ExportPDF(file, ref shtids, options, password);
        }

        public int ExportPDFEx(string file, ref object shtids, int options, int itemListType, ref object items, int alternativeColour, int imageBrightness, string password = default(string))
        {
        ...
        {
            return ComObject.GetActiveAlias(out name);
        }
        ...
        public int GetAllBusbarConnectionIds(ref object ids, int flags = 0)
        {
            return ComObject.GetAllBusbarConnectionIds(ref ids, flags);
        }
        ...
        {
            return ComObject.GetAllParentSheetIds(flags, ids);
        }
        ...
        {
            return ComObject.GetAttributeDefinitionIds(ref ids);
        }
        ...
        public int GetBusbarIds(ref object ids, int flags = 0)
        {
            return ComObject.GetBusbarIds(ref ids, flags);
        }
        ...
        public int GetCavityPartIds(ref object ids, int type = default(int))
        {
            return ComObject.GetCavityPartIds(ref ids, type);
        }

        public int GetClipboardIds(ref object ids)
        {
            return ComObject.GetClipboardIds(ref ids);
        }
        ...
        {
            return ComObject.GetCursorPositionInteractively(out xpos, out ypos, flags, out keysAndMouseButtons, out grid, out gridX, out gridY, boxWidth, boxHeight);
        }
        ...
        {
            return ComObject.GetGeneratedWireNameFormatEx(out attPrefix, out attType, out attname);
        }
        ...
        {
            return ComObject.GetGUIDOfId(id);
        }
        ...
        {
            return ComObject.GetIdOfGUID(guid);
        }
        ...
        {
            return ComObject.GetInvertDisplayColour();
        }
        ...
        public int GetLastAddedItems(ref object ids, int type = default(int))
        {
        ...
        public int GetLastModifiedItems(ref object ids, int type = default(int))
        {
        ...
        public int GetNewTextIds(ref object ids, int txttyp = default(int), string search_string = "")
        {
        ...
        {
            return ComObject.GetOutbarText(index, lst);
        }
        ...
        {
            return ComObject.GetParentSheetIds(flags, ids);
        }
        ...
        {
            return ComObject.GetPartExtension(part, vers, xl, yl, xh, yh, shtcnt, xp, yp, subcircuitType);
        }
        ...
        {
            return ComObject.GetProjectStructureLocking();
        }
        ...
        {
            return ComObject.GetSelectedBusbarIds(ref ids);
        }
        ...
        {
            return ComObject.GetSelectedConnectLineIds(ref ids);
        }
        ...
        {
            return ComObject.GetSelectedEmbeddedObjectIds(ref ids);
        }
        ...
        {
            return ComObject.GetSheetTreeStructure(structarr, info);
        }

        public int GetShortcutPosition(ref object xpos, ref object ypos)
        {
            return ComObject.GetShortcutPosition(xpos, ypos);
        }
        ...
        public int GetSymbolIds(ref object ids, string symnam = default(string), int level = -1, int view = -1)
        {
        ...
        {
            return ComObject.GetTextTypes(out textTypeDefinitions);
        }
        ...
        {
            return ComObject.GetTreeSelectedBusbarIds(ref ids);
        }
        ...
        {
            return ComObject.GetTreeSelectedSlotIds(ref ids);
        }
        ...
        public int ImportBoardLayout(ref object exclusions, string type, string file = default(string), int flags = default(int), string map = default(string))
        {
            return ComObject.ImportBoardLayout(ref exclusions, type, file, flags, map);
        }
        ...
        public int ImportDrawingForProjectGeneration(string name, int unique, uint flags, ref object substitutes, ref object allowedTexttypes, ref object allowedAttributenames, ref object resultArray, double posx = -950309, double posy = -950309)
        {
            return ComObject.ImportDrawingForProjectGeneration(name, unique, flags, ref substitutes, ref allowedTexttypes, ref allowedAttributenames, out resultArray, posx, posy);
        }
        ...
        {
            return ComObject.IsVariantStructurePasswordProtected();
        }
        ...
        {
            return ComObject.LoadTableConfiguration(file, table);
        }
        ...
        {
            return ComObject.OpenGranularDesignProject(folder, options);
        }
        ...
        public int OptimizeMemory(int flags = 0)
        {
            return ComObject.OptimizeMemory(flags);
        }

        public int OverwriteMultiuser(string name, string filename, int unlock)
        {
            return ComObject.OverwriteMultiuser(name, filename, unlock);
        }
        ...
        {
            return ComObject.RemoveAccessControlInformation();
        }
        ...
        public int RenameMultiuser(string oldname, string newname, string newdesc = default(string))
        {
        ...
        {
            return ComObject.ResetSelection();
        }
        ...
        public int SaveProjectWithoutVariants(string name, int compressed = -1)
        {
            return ComObject.SaveProjectWithoutVariants(name, compressed);
        }

        public int SaveSheetsAsSingleUser(string name, ref object shtids, int compressed = -1, string completeName = "", int completeCompressed = -1)
        {
        ...
        {
            return ComObject.SaveTableConfiguration(file, table);
        }

        public int SetActiveOptionIds(ref object ids)
        {
            return ComObject.SetActiveOptionIds(out ids);
        }
        ...
        {
            return ComObject.SetGeneratedWireNameFormatEx(ref attPrefix, ref attType, ref attname);
        }
        ...
        {
            return ComObject.SetInvertDisplayColour(value);
        }
        ...
        {
            return ComObject.SetOptionExpressions(ref itemarray, ref expressions);
        }
        ...
        {
            return ComObject.SetProjectStructureLocking(@lock);
        }
        ...
        {
            return ComObject.SetRGBValue(index, r, g, b);
        }
        ...
        {
            return ComObject.SetSettingValue(name, value);
        }

        public int SetSheetTreeStructure(ref object structarr, ref object info)
        {
            return ComObject.SetSheetTreeStructure(structarr, info);
        }
        ...
        {
            return ComObject.SetTerminalPlanSettings(out settings);
        }
        ...
        public int UndoAfterExecution(int newval = -1)
        {
            return ComObject.UndoAfterExecution(newval);
        }
        ...
        public int UpdateComponentVersion(string name, string version, int withSymbol = 1)
        {
            return ComObject.UpdateComponentVersion(name, version, withSymbol);
        }
