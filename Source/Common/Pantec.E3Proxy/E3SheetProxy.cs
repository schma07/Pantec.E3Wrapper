...
namespace Pantec.E3Proxy
{
    ...
    /// </summary> 
    public sealed class E3SheetProxy : E3ProxyBase, IAttributed
    {
        ...
        {
            return ComObject.AlignObjects(reference, ref ids, mode);
        }
        ...
        public int CreateTopologyEx(int modi, string name, string symbol, int position, int before, double refx, double refy, double refscale, int flags = 0)
        {
            return ComObject.CreateTopologyEx(modi, name, symbol, position, before, refx, refy, refscale, flags);
        }
        ...
        public int Export(string format, int version, string file, int flags = default(int))
        {
            return ComObject.Export(format, version, file, flags);
        }

        public int ExportImage(string format, int version, string file, int dpi = default(int), int compressionmode = default(int))
        {
        ...
        {
            return ComObject.Get2DViewSheetDisplayOnlyBorder();
        }
        ...
        {
            return ComObject.GetDXFSize(filename, font, ref dx, ref dy, ref scale);
        }

        public int GetEmbeddedObjectIds(ref object ids)
        {
            return ComObject.GetEmbeddedObjectIds(ref ids);
        }
        ...
        {
            return ComObject.GetOwners(ref owners);
        }
        ...
        {
            return ComObject.GetSlotIdsFrom2DView(ref ids);
        }
        ...
        public int ImportDXF(string filename, double scale, double x, double y, int rot, string font, int flags = 0)
        {
            return ComObject.ImportDXF(filename, scale, x, y, rot, font, flags);
        }
        ...
        {
            return ComObject.IsReadOnlyInProject();
        }
        ...
        {
            return ComObject.SelectIds(ref symbolIds, out selectedIds);
        }

        public int Set2DViewSheetDisplayOnlyBorder(int display_border)
        {
            return ComObject.Set2DViewSheetDisplayOnlyBorder(display_border);
        }
        ...
        public int SetFormat(string sym, string rot = default(string))
        {
        ...
        {
            return ComObject.SetProduct(newproduct);
        }

        public int SetReadOnlyInProject(int readonlyproject)
        {
            return ComObject.SetReadOnlyInProject(readonlyproject);
        }
