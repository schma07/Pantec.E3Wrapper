...
namespace Pantec.E3Proxy
{
    ...
    /// </summary> 
    public sealed class E3DimensionProxy : E3ProxyBase, IAttributed
    {
        ...
        public int CreateEx(int dimtyp, int sheet, ref object x, ref object y, int flags = default(int))
        {
        ...
        {
            return ComObject.GetCenterTextPosition();
        }
        ...
        {
            return ComObject.SetCenterTextPosition(value);
        }
