...
namespace Pantec.E3Proxy
{
    ...
    /// </summary> 
    public sealed class E3GraphProxy : E3ProxyBase, IAttributed
    {
        ...
        {
            return ComObject.CreateCloud(shti, pnts, ref x, ref y);
        }
        ...
        {
            return ComObject.GetCloud(ref npnts, ref xarr, ref yarr);
        }
        ...
        {
            return ComObject.OptimizeGraphicObjects(ref ids, mode, angle);
        }
