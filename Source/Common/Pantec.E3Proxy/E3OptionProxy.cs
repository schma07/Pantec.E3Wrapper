...
namespace Pantec.E3Proxy
{
    ...
    /// </summary> 
    public class E3OptionProxy : E3ProxyBase, IAttributed
    {
        ...
        {
            return ComObject.GetAllDeviantAttributeIds(ref ids);
        }
        ...
        {
            return ComObject.IsInUseByObject();
        }
        ...
        public int Sort(int sortMode = 0)
        {
            return ComObject.Sort(sortMode);
        }
