...
namespace Pantec.E3Proxy
{
    ...
    /// </summary>
    public sealed class E3SymbolProxy : E3ProxyBase, IAttributed
    {
        ...
        {
            return ComObject.AssignToConnector(ref AssignToPinIds, ref AssignToPinIds_connected, flags);
        }
        ...
        {
            return ComObject.GetSymbolType();
        }

        public int GetSymbolTypeId()
        {
            return ComObject.GetSymbolTypeId();
        }
        ...
        {
            return ComObject.GetTableBreakTableAfter();
        }

        public int GetTableBreakTableAfterNumberOfRows()
        {
            return ComObject.GetTableBreakTableAfterNumberOfRows();
        }

        public int GetTableOneRowForEachCore()
        {
            return ComObject.GetTableOneRowForEachCore();
        }

        public int GetTablePinsWithoutCores()
        {
            return ComObject.GetTablePinsWithoutCores();
        }
        ...
        public int ModifyBlockSize(int border, double delta, int flags = default(int))
        {
            return ComObject.ModifyBlockSize(border, delta, flags);
        }

        public int Place(int shti, double x, double y, string rot = default(string), double scale = default(double), int maintaintextsize = default(int))
        {
        ...
        public int PlaceDynamic(int shti, double x, double y, double height, double width, string texttemplate = default(string), short fitsymbol = default(short))
        {
        ...
        public int PlacePins(ref object pinarray, string symname, string vers, int shti, double x, double y, string rot, double scale = default(double))
        {
            return ComObject.PlacePins(pinarray, symname, vers, shti, x, y, rot, scale);
        }

        public int PlacePinView(int pinid, int shti, string symname, string version, double x, double y, string rot, double scale = default(double), int maintaintextsize = default(int))
        {
            return ComObject.PlacePinView(pinid, shti, symname, version, x, y, rot, scale, maintaintextsize);
        }

        public int PlaceTable(int fromID, double x, double y, string rot = default(string), double scale = default(double), int maintaintextsize = default(int))
        {
        ...
        {
            return ComObject.RemoveFromSheetReference();
        }
        ...
        {
            return ComObject.SetSelected(newval);
        }
        ...
        {
            return ComObject.SetTableBreakTableAfter(newval);
        }

        public int SetTableBreakTableAfterNumberOfRows(int newval)
        {
            return ComObject.SetTableBreakTableAfterNumberOfRows(newval);
        }

        public int SetTableOneRowForEachCore(int newval)
        {
            return ComObject.SetTableOneRowForEachCore(newval);
        }

        public int SetTablePinsWithoutCores(int newval)
        {
            return ComObject.SetTablePinsWithoutCores(newval);
        }
